...
$.fn._vs.chart.trailChartRound = function(_this,fn,options) {
  ...
  this.setupPieChartPhysics = function(_this){
    ...
    var axis   = pivot(csX,csY,100, _this.settings.chart.wallColor);
  ...
  function pivot (centerSceneX,centerSceneY,radius,color){
    ...
    axis.m_userData     = {type:"wall",fillColor:"#000",r:radius}
    return  axis;
  }
